...
" Search {{{1
hi IncSearch cterm=UNDERLINE ctermfg=black ctermbg=229 gui=UNDERLINE guifg=Black guibg=#FFE568
hi Search term=reverse cterm=UNDERLINE ctermfg=black ctermbg=229 gui=NONE guifg=Black guibg=#FFE568
...
" Fold {{{1
hi Folded gui=NONE guibg=#B5EEB5 guifg=black ctermfg=green ctermbg=NONE
...
hi Visual term=reverse ctermfg=yellow ctermbg=grey gui=NONE guifg=Black guibg=#BDDFFF
hi VisualNOS term=reverse ctermfg=yellow ctermbg=grey gui=UNDERLINE guifg=Black guibg=#BDDFFF
...
hi PreProc term=UNDERLINE ctermfg=5 guifg=#1071CE
hi Special term=BOLD ctermfg=1 guifg=red2
hi Statement term=BOLD ctermfg=6 gui=NONE guifg=#F06F00
hi Tag term=BOLD ctermfg=DarkGreen guifg=DarkGreen
hi Todo term=STANDOUT ctermbg=Yellow ctermfg=blue guifg=Blue guibg=Yellow
hi Type term=UNDERLINE ctermfg=6 gui=NONE guifg=Blue
...
" Spell Checker {{{1
if v:version >= 700
    highlight SpellBad    term=reverse ctermfg=red  ctermbg=NONE gui=undercurl guisp=Red
    highlight SpellCap    term=reverse  ctermfg=red ctermbg=NONE  gui=undercurl guisp=Blue
    highlight SpellRare   term=reverse  ctermfg=red ctermbg=NONE gui=undercurl guisp=Magenta
...
hi VertSplit ctermbg=230 ctermfg=230
